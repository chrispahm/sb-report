module.exports = (data) => {
    ...
    ${animalWorkVaries === true ? 'Due to seasonal shifts within the herd sizes, work loads for the animals differs between the months.' : 'Due to homogenous herd sizes, work related to animals was simulated to remain equal throughout the year.'}
